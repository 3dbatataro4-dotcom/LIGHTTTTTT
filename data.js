...
const DB = {
    ...
    npc: {
        ...
        nathanael: { 
            ...
            victoryMsg: '既然霧散了，這座破漁村的地價肯定會翻倍……真麻煩，錢多得花不完也是一種困擾。腓力！過來幫我搬金幣！'
        },
        molly: {
            name: '茉莉 (黑市)', id: 'molly',
...
const CHAT_DB = {
    ...
    'costa_win': {
        ...
        1: {
            face: 'costa', speaker: '科絲塔',
            msg: '「這可是我的寶貝！是那個不好心的幽靈送我的！」',
            choices: [{ text: '「...真奇怪。」 (結束對話)', next: -1 }]
        },
        2: {
            face: 'costa', speaker: '科絲塔',
    ...
    'nathanael_win': {
        0: {
            face: 'nathanael', 
            speaker: '拿但業',
            msg: '「（拿但業慵懶地躺在賭場的貴賓席上，連眼皮都懶得抬一下）<br><br>外面吵死了，那些平民都在喊什麼英雄……害我連午覺都睡不好。腓力！腓力死哪去了？去把窗戶關上，陽光太刺眼了。」',
            choices: [
                { text: '「我們打倒了克拉肯，你不高興嗎？」', next: 1 },
                { text: '「你對我們能活著回來很意外？」', next: 2 },
                { text: '「這座小鎮以後歸你管了？」', next: 3 }
            ]
        },
        1: {
            face: 'nathanael', 
            speaker: '拿但業',
            msg: '「高興？這種流汗又耗體力的活動有什麼好高興的？<br>不過……既然航線通了，我進口的紅酒就能準時送達了。這點倒還算值得嘉獎。做得不錯，雖然那是你們應盡的義務。」',
            choices: [{ text: '「……。」 (結束對話)', next: -1 }]
        },
        2: {
            face: 'nathanael', 
            speaker: '拿但業',
            msg: '「意外？不，我從不意外。雖然機率上你們死定的可能性是 99%，但我總是會買那 1% 的保險。<br>這就是『命運』對貴族的偏愛——無論你們輸贏，最後賺錢的總是我。」',
            choices: [{ text: '「這就是資本的力量嗎……」 (結束對話)', next: -1 }]
        },
        3: {
            face: 'nathanael', 
            speaker: '拿但業',
            msg: '「管？別開玩笑了，管理多累啊。<br>我只需要買下這裡的地皮，然後躺著收租就好。至於那些修路、重建的粗活……當然是交給腓力去做。腓力！過來幫我按摩肩膀，我數錢數得手痠了。」',
            choices: [{ text: '「替腓力感到默哀。」 (結束對話)', next: -1 }]
        }
    }
};
